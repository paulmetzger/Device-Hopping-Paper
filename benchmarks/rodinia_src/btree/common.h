...
//======================================================================================================================================================150
# ifdef __cplusplus
#include <cstdint>					// (in path known to compiler)			needed by uint32_t
#include <cstdbool>				// (in path known to compiler)			needed by true/false, bool
#include <cstdlib>					// (in path known to compiler)			needed by malloc
#include <cstdio>
#else
#include <stdint.h>
#include <stdbool.h>
